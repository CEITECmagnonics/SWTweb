...
- **µBLS modeling** (`#/bls`): micro-focused Brillouin light scattering after Wojewoda et al., [PRB 110, 224428 (2024)](https://doi.org/10.1103/PhysRevB.110.224428) — thermal spectra (with parameter sweeps → 2D maps) and detection k-sensitivity for coherently excited spin waves, including an editable optical layer stack (air / cover / magnet / substrate) and accuracy controls.
